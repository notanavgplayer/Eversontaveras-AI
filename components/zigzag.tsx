                ...
                <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                  ...
                  >
                    <div className="md:pr-4 lg:pr-12 xl:pr-16">
                      ...
                      <h3 className="h3 mb-3 text-black">
                        Power Up Your Productivity with AI-Powered Tools:
                        Accuracy Meets Ease of Use
                      </h3>
                      <p className="text-[17px] text-zinc-500 mb-4">
                        ...
                        Artificial intelligence (AI) tools are making this
                        vision a reality, offering a diverse range of solutions
                        that are both remarkably accurate and delightfully
                        user-friendly.
                      </p>
                      <ul className="text-lg text-zinc-600 -mb-2">
                        <li className="flex items-center mb-2">
